...
namespace WebApiApp.Service
{
    class Service
    {
        ...
        {
            string URL = "http://192.168.4.31:44314/token";
        ...
        public async Task<bool> RegisterAsync(string email, string password, string phonenumber, string username)
        {
            bool Response = false;
            await Task.Run(() =>
            {
                ...
                var response = client.PostAsync("http://192.168.4.31:45457/" + "api/Account/Register", httpContent);
